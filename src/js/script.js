...
$(function () {
    ...
    var eventHTML = "Начинается сезон посвятов. Первокуры празднуют и Физтех.Радио празднует вместе с ними в нашей новой рубрике муз. посвят.<br><br>" +
        "Первыми пройти ритуал посвящения и постигнуть таинства общажных вечеринок предстоит первокурам факультета инноваций и высоких технологий. Поздравляем всех новоиспеченных ФИВТов и желаем им поменьше багов и побольше безошибочных компиляций.<br><br>" +
