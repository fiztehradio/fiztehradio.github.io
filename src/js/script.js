...
$(function () {
    ...
    // var mevSMM = (1537142400 - new Date() / 1000) < 0 && (1537671600 - new Date() / 1000) > 0; // 17 сентября 2018 года, 0:00:00
    // var mevText = "В ближайшие выходные совместно с mipt.live мы организуем большой 12-часовой live-концерт в нашей радиорубке:<br>техничные пассажи, мощные панчи, лиричные баллады  — все самое актуальное из музыкальной жизни Физтеха." +
    ...
    //     "  </tr>\n" +
    //     "  <tr>\n" +
    //     "    <td>Трио Алексея Бычкова</td>\n" +
    //     "    <td>17:00</td> \n" +
    //     "  </tr>\n" +
    //     "  <tr>\n" +
    //     "    <td>Промышленный проезд</td>\n" +
    //     "    <td>18:00</td> \n" +
    //     "  </tr>\n" +
    //     "  <tr>\n" +
    //     "    <td>Некондиция</td>\n" +
    ...
    //     "  </tr>\n" +
    //     "  <tr>\n" +
    //     "    <td>Дамира Гареева и Андрей Пикунов</td>\n" +
    //     "    <td>1:00</td> \n" +
    //     "  </tr>\n" +
    //     "  <tr>\n" +
    //     "    <td>Закрытие</td>\n" +
